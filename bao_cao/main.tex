...
\begin{enumerate}
    \item Hàm Dirac được khai báo bằng khối \textbf{Hàm Dirac}. Khối này là một hệ con (subsystem) được dựa vào một blog của MATLAB tại địa chỉ \url{https://blogs.mathworks.com/simulink/2024/08/23/how-can-i-create-an-impulse-delta-signal-in-simulink/}.
    \begin{figure}[ht]
        \centering
